...
陳老闆,**模型告訴你 3 件事**:① 已試聽過 (×2.6 odds) + 朋友介紹 (×2.2) 是雙王牌,② 距離越遠 (-0.82) 越流失,③ 網站表單 lead (-0.76) conversion 是所有管道最差。背後邏輯:試聽 = 動機真實 + 朋友介紹 = 高 trust 預設值 + 表單 = 隨便填留資料的居多。

**3 個 outreach 流程改造**:
**(1) 砸資源在「試聽轉換」**: 預算別再全砸 FB 廣告 (β -0.59), 改投免費 / 半價試聽日 → 1 場 30 學生試聽 conversion 比 100 個 FB lead 高 6 倍。週末舉辦學科主題試聽 (e.g. 「國中數學期中考衝刺 3 小時免費」), 留聯絡資料當天加 LINE 即可;
**(2) 啟動「老學生介紹獎勵金」**: 朋友介紹 +2.2× odds 強得驚人, 每介紹 1 個成交給介紹人 NT$500 (但限期 / 限報名 4 週內), 1 萬獎勵金可帶 20+ 新報名 = ROI > 5x;
**(3) 距離 > 5km 的 lead 不主動 follow-up**: 距離係數 -0.82 強, 遠距 conversion 極低, 浪費櫃台時間 → 改寄電子報 nurture, 主動回應就接, 不主動撥電話。

**本週 15 leads 行動分配**: 6 個 🟢 高機率 (L1010 / L1014 / L1004 / L1002 / L1015 / L1003) 今天就要打 + 推「8 月暑期班套裝優惠 NT$15,800」+ 老師個別導覽。4 個 🟡 中高 (L1005 / L1007 / L1011 / L1006) 明天 LINE 個人化訊息 + 附試聽日邀請。5 個 🟠/🔴 中低標準 nurture。

⚠️ **風險**: 模型完全依賴歷史 180 件, **若你過去就習慣只 follow-up 試聽過的, 預測 model 會自我強化偏見** — 偶爾抽 1-2 個低機率 lead 也打看看, 累積反例 data 才能持續優化。
